...
namespace JsonWebTokenTests
{
    public class RsaContext : tokenRoundtripContext
    {
        ...
        {
            KeyContainer = new FakeRsaKeyRepository(cngKey);
            TinyIoCContainer.Current.Register(typeof(ICngKeyProvider), typeof(FakeRsaKeyRepository), KeyContainer);
            TinyIoCContainer.Current.Register(typeof(IRsaPublicKeyProvider), typeof(FakeRsaKeyRepository), KeyContainer);
        }
    }
